...
# Garante que o banco e o usuário 'admin' existam ao iniciar
...
def pagina_principal():
    ...
    st.write("Bem-vindo ao sistema seguro integrado ao banco de dados SQLite!")

    # Exemplo de conteúdo do seu dashboard
